...
/**
 * The first content-pillar page, shared by /rehber/freelance-teslim-ve-kabul
 * and /en/guide/freelance-delivery-and-acceptance.
 *
 ...
 */
export function GuideDeliveryAcceptanceView({
  locale,
}: Readonly<{ locale: Locale }>) {
  const t = GUIDE_DELIVERY_ACCEPTANCE_COPY[locale];
      ...
      <article className="flex-1 px-6 pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-16 border-t border-border pt-10">
            <h2 className="text-lg font-semibold tracking-tight text-foreground">{t.faqHeading}</h2>
