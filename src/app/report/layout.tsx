...
/**
 * The public shared-report shell -- same shape as profile/layout.tsx (a
 * stranger reading someone's shared QA report is exactly the same kind of
 * visitor as a stranger reading someone's public profile), duplicated
 * rather than shared: it's small, and the two route segments have no
 * reason to actually be coupled.
 */
export default async function ReportLayout({
  ...
  return (
    <div className="min-h-[100dvh] bg-zinc-50 dark:bg-zinc-950">
      ...
      <main className="mx-auto max-w-2xl p-4 py-8 sm:p-6 lg:p-8">{children}</main>
    </div>
  );
}
